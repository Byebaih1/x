...
-- ตั้งค่า BannerManager
BannerManager:SetLibrary(Fluent)

-- โหลด Banner จาก URL
-- เปลี่ยน Url เป็นรูปของคุณเอง (png/jpg จาก imgur, discord CDN, etc.)
BannerManager:LoadBanner({
    Url = "https://i.imgur.com/6Z6HFKQ.jpeg", -- ตัวอย่าง Banner (เปลี่ยนได้)
    Height = 80,          -- ความสูง banner (pixels)
    ScaleType = "Crop",   -- Crop = ครอบตัด / Fit = ปรับพอดี / Stretch = ยืด
    Transparency = 0,     -- 0 = ทึบสนิท, 1 = โปร่งใสหมด
})

-- ถ้าอยากลบ Banner ออก ใช้:
